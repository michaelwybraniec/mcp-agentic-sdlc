...
See [workflow.md — Section 11](./docs/workflow.md#11-live-kanban-board) for column rules, agent commits panel, time tracking, and backlog-complete flow.
...
Follow the recipes and [`AWP.md`](./AWP.md) for ongoing development. Use `backlog_sync` so Kanban stays in sync with task markdown.
